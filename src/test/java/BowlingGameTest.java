...
public class BowlingGameTest {
    ...
    void should_right_when_have_both_strike_and_spare_but_not_10th() {
        BowlingGame bowlingGame = new BowlingGame();
        int[] numberOfDown = {1, 2, 10, 6, 4, 3, 2, 4, 3, 2, 3, 1, 3, 2, 1, 3, 4, 3, 4};
    ...
    void should_right_when_all_condition_in_middle_and_spare_at_10th() {
        BowlingGame bowlingGame = new BowlingGame();
        int[] numberOfDown = {1, 2, 10, 6, 4, 3, 2, 4, 3, 2, 3, 1, 3, 2, 1, 3, 4, 7, 3, 5};
    ...
    @Test
    void should_right_when_all_condition_in_middle_and_strike_at_10th() {
        BowlingGame bowlingGame = new BowlingGame();
        int[] numberOfDown = {1, 2, 10, 6, 4, 3, 2, 4, 3, 2, 3, 1, 3, 2, 1, 3, 4, 10, 5, 5};
    ...
    @Test
    void should_right_when_all_strike() {
        BowlingGame bowlingGame = new BowlingGame();
